...
public class SmsDemoTest {
    ...
    static final String accessKeyId = "LTAI4FyNAjcq3aU19KohuX46";
    static final String accessKeySecret = "6ytvKi6YWLaWXtPEHtZviO0py0lfoL";
    ...
    public static SendSmsResponse sendSms() throws ClientException, com.aliyuncs.exceptions.ClientException {
        ...
        //必填:待发送手机号
        request.setPhoneNumbers("13631578987");
        //必填:短信签名-可在短信控制台中找到
